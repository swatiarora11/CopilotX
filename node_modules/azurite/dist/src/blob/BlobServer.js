...
class BlobServer extends ServerBase_1.default {
    ...
    constructor(configuration) {
        ...
        const metadataStore = new LokiBlobMetadataStore_1.default(configuration.metadataDBPath, configuration.isMemoryPersistence);
