        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.inputData) {
                for (const binding of req.inputData) {
                    ...
                    let input;
                    if ((0, isTrigger_1.isHttpTrigger)(bindingType) && (0, setup_1.isHttpStreamEnabled)()) {
...
class ProgrammingModel {
    ...
    getCapabilities(capabilities) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, setup_1.lockSetup)();
            if ((0, setup_1.isHttpStreamEnabled)()) {
...
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isHttpStreamEnabled = exports.setup = exports.lockSetup = void 0;
const errors_1 = __webpack_require__(/*! ./errors */ "./src/errors.ts");
const tryGetCoreApiLazy_1 = __webpack_require__(/*! ./utils/tryGetCoreApiLazy */ "./src/utils/tryGetCoreApiLazy.ts");
const workerSystemLog_1 = __webpack_require__(/*! ./utils/workerSystemLog */ "./src/utils/workerSystemLog.ts");
let options = {};
...
function setup(opts) {
    ...
    options = opts;
    (0, workerSystemLog_1.workerSystemLog)('information', `Setup options: ${JSON.stringify(options)}`);
}
exports.setup = setup;
function isHttpStreamEnabled() {
    return !!options.enableHttpStream;
}
exports.isHttpStreamEnabled = isHttpStreamEnabled;
